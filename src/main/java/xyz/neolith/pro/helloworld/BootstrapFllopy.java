package xyz.neolith.pro.helloworld;
...
/**
 * load the slogan in the start page
 * then enter the dead while
 *
 * @author sunligang
 * @date 2018/07/04
 */
public class BootstrapFllopy {
    /**
     * the machine instruction from the assembly
     *
     * when the machine start from the fllopy,
     * it will white this {@code imgContent} into the bios
     *
     */
    ...
    public BootstrapFllopy(String s) {
        //  complement
        ...
        // the intel core require us to white this "0x55" and "0xaa"
    ...
    public static void main(String[] args) {
        BootstrapFllopy op = new BootstrapFllopy("Hello Bordeaux");
        op.makeFllopy();
    }
}
